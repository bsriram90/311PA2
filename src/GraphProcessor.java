...
public class GraphProcessor {
	...
	public List<String> bfsPath(String u, String v) {
		return null;
	}
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		GraphProcessor g = new GraphProcessor("largegraph.txt");
		long end = System.currentTimeMillis();
		System.out.println((end-start)/1000.0 + " seconds");
		/*System.out.println(g.isEdge("Ames", "Chicago"));
		System.out.println(g.isReverseEdge("Ames", "Chicago"));
		System.out.println(g.isReverseEdge("Chicago", "Ames"));
		System.out.println(g.isEdge("Chicago", "Phoenix"));
		System.out.println(g.isEdge("Boston", "Phoenix"));
		System.out.println(g.isEdge( "Phoenix", "Chicago"));
		g.computeFinishTimes();*/
		//g.printFinishTimes();
		System.out.println(g.numComponents());
		//System.out.println(g.sameComponent("Ames",  "Denver"));
		//System.out.println(g.sameComponent("Ames",  "Boston"));
